...
monitor:9090 Prometheus -> app:8080/metrics                    # реализовано: supportdesk product metrics + Product observability v2
...
Dashboard показывает Targets UP, CPU/RAM/Disk по host, Web nginx logs, App logs, product ticket metrics, Product Observability v2 panels и Active Alerts.
...
```text
Последний завершенный этап: Этап 13. Product observability v2.
Текущий следующий этап: Этап 14. HTTP request metrics, error-rate alerts и latency.
Далее: HTTP/error-rate metrics, Dockerization, PostgreSQL, DB observability, Telegram bot, hardening, Ansible automation v2, final README/demo.
```
...
```text
Формальная готовность по расширенному roadmap: 13/21 основных этапов завершены ≈ 62%.
Готовность core infrastructure lab: 100% по этапам 1–10.
Admin/Ansible foundation: 100%.
Product model v2: 100%.
Инженерная готовность по новому production-like scope: 66–71%.
Демонстрационная готовность текущего core-проекта: 90–94%.
...
| 14. HTTP request/error-rate observability | следующий этап | 0–10% | Request metrics, latency и error-rate alerts еще не реализованы. |
