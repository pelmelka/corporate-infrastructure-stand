...
`log`: **готов как Loki logging server и принимает nginx logs от web и app logs от app**.
...
- закрепить статический IP `192.168.85.137`;
- установить Prometheus, Grafana, Alertmanager;
- затем подключить Loki как datasource в Grafana.
